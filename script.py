...
def spoofing_arp(ip_objetivo, widget_salida):
    ...
    try:
        # Usar una MAC falsa para interrumpir la conexión
        mac_falsa = "00:00:00:00:00:00"
        ...
        while ataque_en_curso:
            ...
            widget_salida.insert(tk.END, f"Enviando ARP spoofing a {ip_objetivo} con MAC falsa...\n")
